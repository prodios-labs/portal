...
export function usePortalPosition({
  ...
  const [contentVisibility, setContentVisibility] = useState<ContentVisibility>(ContentVisibility.HIDDEN)

  const [contentContainerPosition, setContentContainerPosition] = useState<ContentContainerPosition | undefined>(
    undefined,
  )
